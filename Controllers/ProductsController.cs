...
namespace MvcCoreWebApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AdventureWorksLt2016Context context)
        {
            _context = context;
        }
        ...
        {
            var adventureWorksLt2016Context = _context.Products.Include(p => p.ProductCategory).Include(p => p.ProductModel);
            return View(await adventureWorksLt2016Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdventureWorksLt2016Context.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
