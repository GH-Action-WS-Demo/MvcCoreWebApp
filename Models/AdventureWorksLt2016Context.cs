...
public partial class AdventureWorksLt2016Context : DbContext
{
    ...
    public AdventureWorksLt2016Context(DbContextOptions<AdventureWorksLt2016Context> options, IOptions<DbConnectionSettings> dbConnectionSettings)
       : base(options)
    {
        this._dbConnectionSettings = dbConnectionSettings.Value;
    }
